...
@EndUserText.label: 'Int.View - Manage File PO Item'
@Metadata.ignorePropagatedAnnotations: true
define root view entity ZI_M_PO_ITEM
  as select from ztb_m_po_item
  association [0..1] to zi_req_sta_mass_po_vh as _OverallStatus on $projection.Status = _OverallStatus.Status
  composition [0..*] of zi_d_po_item          as _DataFile
{
  key uuid          as Uuid,
      zcount        as Zcount,
      status        as Status,
